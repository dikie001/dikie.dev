...
import { Code, Save, Check, Plus, Trash2, X, GripVertical } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {skills.map((category) => (
          <Card key={category.id} className="hover:border-primary/50">
                ...
                <div className="flex flex-wrap gap-2">
                  {category.items.map((skill, index) => (
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          removeSkillFromCategory(category.id, index)
                        }
