            ...
            <div className="container relative z-10 py-32">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <motion.div
                        ...
                        className="mb-6"
                    >
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[var(--border-gold)] bg-[rgba(212,175,55,0.05)] text-[var(--luxury-gold)] text-sm font-medium">
