...
export function ExperienceContent() {
    ...
    const toggleCurrent = (id: number) => {
        setExperiences(experiences.map(e => e.id === id ? { ...e, current: !e.current } : e));
    };
    ...
    const updateAchievement = (index: number, value: string) => {
        if (editForm) {
            setEditForm({
                ...editForm,
                achievements: editForm.achievements.map((a, i) => i === index ? value : a)
            });
        }
    };
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => setEditForm({ ...editForm, current: !editForm.current })}
                                            className="w-full"
                                        >
