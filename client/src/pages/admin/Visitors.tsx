                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-border">
                                    <th className="text-left py-3 px-4 text-sm font-medium text-muted-foreground">Visitor</th>
                            ...
                            <tbody>
                                {filteredVisitors.map((visitor) => {
                                    ...
                                    return (
                                        <tr key={visitor.id} className="border-b border-border last:border-0 hover:bg-secondary/50">
                                            <td className="py-3 px-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-muted-foreground">{visitor.ip}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="py-3 px-4">
                                            ...
                                            <td className="py-3 px-4">
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className="text-sm">{visitor.pages.length} pages</span>
                                                </div>
                                            </td>
                                            <td className="py-3 px-4 text-sm">{visitor.referrer}</td>
                                            <td className="py-3 px-4 text-sm">{visitor.duration}</td>
                                            <td className="py-3 px-4 text-sm text-muted-foreground">{visitor.timestamp}</td>
                                            <td className="py-3 px-4">
                                                {visitor.isOnline ? (
